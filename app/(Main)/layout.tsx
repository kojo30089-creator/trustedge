    ...
    segments.map((segment, index) => {
      ...
      return isLast ? (
        ...
        <BreadcrumbItem key={href}>
          <BreadcrumbLink
            href={href}
            className="font-mono text-[10px] uppercase tracking-widest text-slate-500 hover:text-[#e51837] transition-colors"
          >
            {label}
          </BreadcrumbLink>
          ...
          <header className="flex sticky top-0 h-16 shrink-0 items-center justify-between px-6 bg-white/80 dark:bg-[#030508]/80 backdrop-blur-xl z-50 border-b border-slate-200 dark:border-white/10">
            ...
            <div className="flex items-center gap-4">
              ...
              <Separator
                ...
                className="h-5 bg-slate-200 dark:bg-white/10"
              />
              <Breadcrumb>
                <BreadcrumbList>
                  {segments.length === 0 ? (
            ...
            <div className="flex items-center gap-2">
              ...
              <Separator
                orientation="vertical"
                className="h-5 mx-2 bg-slate-200 dark:bg-white/10 hidden sm:block"
              />
              ...
              <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-lg border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/5">
                ...
                <span className="font-mono text-[9px] font-bold uppercase tracking-widest text-slate-600 dark:text-slate-400">
                  Sync: Live
                </span>
              </div>
            </div>
